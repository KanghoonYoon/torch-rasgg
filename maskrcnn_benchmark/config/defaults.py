...
_C.GLOBAL = CN()
_C.GLOBAL.DATASET_NAME = 'vg'
_C.GLOBAL.CHOOSE_BEST_MODEL_BY_METRIC='F'
# ---------------------------------------------------------------------------- #
# RASGG
# ---------------------------------------------------------------------------- #
_C.TYPE = None # 'retag' 
_C.RASGG = CN()
_C.RASGG.MEMORY_SIZE = 15
_C.RASGG.NUM_RETRIEVALS = 5
_C.RASGG.RETRIEVAL_FUSION = 'normadd'
_C.RASGG.MODEL_LOGIT_COEF = 1.0
_C.RASGG.RETRIEVAL_LOGIT_COEF = 1.0
_C.RASGG.FREQUENCY_LOGIT_COEF = 1.0
_C.RASGG.THRESHOLD = 0.3
_C.RASGG.MIXUP = True
_C.RASGG.MIXUP_ALPHA = 20
_C.RASGG.MIXUP_BETA = 5
_C.RASGG.NUM_CORRECT_BG = 5

_C.REL_LOSS_TYPE = 'ce_rwt'
_C.REWEIGHT_BETA = 0.99999
